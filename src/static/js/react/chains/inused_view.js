...
var InUsedChains = React.createClass({
    ...
    componentDidMount: function () {
        ...
        dispatch(actions.fetchClusters("inused"));
    },
    componentWillUnmount: function () {
        const {dispatch, actions} = this.props;
        dispatch(actions.clearClusters("inused"));
    },
    ...
    onSelect: function(data) {
        ...
        var clustersLength = clusters.get("inUsedClusters").valueSeq().toJS().length;
    ...
    render: function () {
        ...
        )(clusters.get("inUsedClusters").valueSeq().toJS());
                                        ...
                                        <div className="dataTables_filter">
                                            <label>
                                                <Search
                                                    ...
                                                    rows={clusters.get("inUsedClusters").valueSeq().toJS()}
                                                />
                                            </label>
                                        </div>
                                    </div>
